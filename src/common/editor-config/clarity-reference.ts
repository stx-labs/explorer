// Auto-generated from stacks-core. Do not edit manually.
// Run: node scripts/generate-clarity-reference.mjs
...
export const clarity = {
  functions: [
    ...
    {
      name: 'is-standard',
      input_type: 'standard-or-contract-principal',
      output_type: '',
    ...
    {
      name: 'string-to-int?',
      input_type: '(string-ascii|string-utf8)',
      output_type: '',
