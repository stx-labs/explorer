...
const BalanceItem = ({
  ...
  }).format(parseFloat(tokenBalanceUsdValue));
  return (
    <Stack gap={1.5}>
      ...
      <Flex>
        ...
        <RowCopyButton value={tokenBalanceUsdValue} ariaLabel={`copy balance`} />
      </Flex>
    </Stack>
  );
};
    ...
    >
      ...
      <Stack gap={6}>
        <BalanceItem
          ...
          tokenBalanceUsdValue={isStxBalanceDefined ? totalBalanceUsdValue : '-'}
          tokenBalanceType="stx"
        />
        {isSbtcBalanceDefined && (
          <BalanceItem
            tokenBalance={sbtcBalance}
            tokenBalanceUsdValue={sbtcBalanceUsdValue.toString()}
